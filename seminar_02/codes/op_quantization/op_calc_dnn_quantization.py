...
MODELS = {
    3: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_3_ports_v2.0_3_ports/optuna_study/models/top_1_trial_840.keras",
        "batch_size": 256,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_3_ports_v2.0_3_ports/optuna_study/scaler/top_1_trial_840.pkl",
    },
    4: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_4_ports_v2.0_4_ports/optuna_study/models/top_1_trial_534.keras",
        "batch_size": 256,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_4_ports_v2.0_4_ports/optuna_study/scaler/top_1_trial_534.pkl",
    },
    5: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_5_ports_v2.0_5_ports/optuna_study/models/top_1_trial_733.keras",
        "batch_size": 256,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_5_ports_v2.0_5_ports/optuna_study/scaler/top_1_trial_733.pkl",
    },
    6: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_6_ports_v2.0_6_ports/optuna_study/models/top_1_trial_988.keras",
        "batch_size": 256,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_6_ports_v2.0_6_ports/optuna_study/scaler/top_1_trial_988.pkl",
    },
    7: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_7_ports_v2.0_7_ports/optuna_study/models/top_1_trial_385.keras",
        "batch_size": 256,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_7_ports_v2.0_7_ports/optuna_study/scaler/top_1_trial_385.pkl",
    },
    10: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_10_ports_v2.0_10_ports/optuna_study/models/top_1_trial_423.keras",
        "batch_size": 256,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_10_ports_v2.0_10_ports/optuna_study/scaler/top_1_trial_423.pkl",
    },
    15: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_15_ports_v2.0_15_ports/optuna_study/models/top_1_trial_910.keras",
        "batch_size": 256,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/dnn/nas_dnn_15_ports_v2.0_15_ports/optuna_study/scaler/top_1_trial_910.pkl",
    },
}
...
def plot_results(results_by_dataset: dict[str, list[dict[str, float]]]) -> None:
    ...
    for dataset_name, rows in results_by_dataset.items():
        ...
        plt.plot(x_ports, [row["op_q4"] for row in sorted_rows], marker="^", linewidth=1.9, label="DNN (Q=4)")
        plt.plot(x_ports, [row["op_q8"] for row in sorted_rows], marker="v", linewidth=1.9, label="DNN (Q=8)")
        plt.plot(x_ports, [row["op_q16"] for row in sorted_rows], marker="D", linewidth=1.9, label="DNN (Q=16)")
        plt.plot(x_ports, [row["op_q32"] for row in sorted_rows], marker="P", linewidth=1.9, label="DNN (Q=32)")
        ...
        plot_path = os.path.join(PLOTS_DIR, f"op_vs_ports_{dataset_name}_dnn_quantization.png")
        plt.savefig(plot_path, dpi=300)
        plt.close()
        print(f"Saved plot to {plot_path}")


def run_dnn_quantized_op_evaluation() -> None:
    """Run DNN OP evaluation with paper-style embedding quantization sweep.

    The pipeline executes these steps:
    1. Load evaluation datasets and ideal OP baselines.
    2. For each observed-port budget, load the corresponding DNN model.
...
run_dnn_quantized_op_evaluation()
