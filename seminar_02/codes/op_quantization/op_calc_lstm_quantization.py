...
MODELS = {
    3: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_3_ports_v2.0_3_ports/optuna_study/model/top_1_trial_60.keras",
        "batch_size": 128,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_3_ports_v2.0_3_ports/optuna_study/scaler/top_1_trial_60.pkl",
    },
    4: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_4_ports_v2.0_4_ports/optuna_study/model/top_1_trial_867.keras",
        "batch_size": 128,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_4_ports_v2.0_4_ports/optuna_study/scaler/top_1_trial_867.pkl",
    },
    5: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_5_ports_v2.0_5_ports/optuna_study/model/top_1_trial_744.keras",
        "batch_size": 128,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_5_ports_v2.0_5_ports/optuna_study/scaler/top_1_trial_744.pkl",
    },
    6: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_6_ports_v2.0_6_ports/optuna_study/model/top_1_trial_386.keras",
        "batch_size": 128,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_6_ports_v2.0_6_ports/optuna_study/scaler/top_1_trial_386.pkl",
    },
    7: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_7_ports_v2.0_7_ports/optuna_study/model/top_1_trial_364.keras",
        "batch_size": 128,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_7_ports_v2.0_7_ports/optuna_study/scaler/top_1_trial_364.pkl",
    },
    10: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_10_ports_v2.0_10_ports/optuna_study/model/top_1_trial_150.keras",
        "batch_size": 128,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_10_ports_v2.0_10_ports/optuna_study/scaler/top_1_trial_150.pkl",
    },
    15: {
        "model_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_15_ports_v2.0_15_ports/optuna_study/model/top_1_trial_26.keras",
        "batch_size": 128,
        "scaler_path": "/media/matheus/SSD-2/matheus/results/fluidra/nas/v2/lstm/nas_lstm_15_ports_v2.0_15_ports/optuna_study/scaler/top_1_trial_26.pkl",
    },
}
...
def preprocess_model_inputs(x_values: np.ndarray) -> np.ndarray:
    """Reshape scaled features for LSTM model input format.
    ...
    Returns:
        np.ndarray: Reshaped tensor with shape ``(n_samples, 1, n_ports)``.

    Raises:
        ValueError: If the input tensor does not have rank 2.
    """
    if x_values.ndim != 2:
        raise ValueError(f"Expected rank-2 input before LSTM reshape, got shape {x_values.shape}")
...
def plot_results(results_by_dataset: dict[str, list[dict[str, float]]]) -> None:
    ...
    for dataset_name, rows in results_by_dataset.items():
        ...
        plt.plot(x_ports, [row["op_q4"] for row in sorted_rows], marker="^", linewidth=1.9, label="LSTM (Q=4)")
        plt.plot(x_ports, [row["op_q8"] for row in sorted_rows], marker="v", linewidth=1.9, label="LSTM (Q=8)")
        plt.plot(x_ports, [row["op_q16"] for row in sorted_rows], marker="D", linewidth=1.9, label="LSTM (Q=16)")
        plt.plot(x_ports, [row["op_q32"] for row in sorted_rows], marker="P", linewidth=1.9, label="LSTM (Q=32)")
        ...
        plot_path = os.path.join(PLOTS_DIR, f"op_vs_ports_{dataset_name}_lstm_quantization.png")
        plt.savefig(plot_path, dpi=300)
        plt.close()
        print(f"Saved plot to {plot_path}")


def run_lstm_quantized_op_evaluation() -> None:
    """Run LSTM OP evaluation with paper-style embedding quantization sweep.

    The pipeline executes these steps:
    1. Load evaluation datasets and ideal OP baselines.
    2. For each observed-port budget, load the corresponding LSTM model.
...
run_lstm_quantized_op_evaluation()
